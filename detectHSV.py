...
color = {
    ...
    "blue": {"color_lower": np.array([14, 17, 54]), "color_upper": np.array([136, 197, 127])},
...
imgErode = cv2.erode(SelectImg, kernel, iterations=1)  #腐蚀除去相关性小的颜色
...
contours = cv2.findContours(dilated.copy(),cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_NONE)
