...
cv2.imshow("imgGray",gray_image)

cv2.namedWindow('img2')
cv2.resizeWindow("img2", 600, 100) #创建一个500*500大小的窗口
...
cv2.createTrackbar('thresh','img2',0,1000,callback)
while(1): 
    thresh = cv2.getTrackbarPos('thresh', 'img2')

    ret,detected_thresh=cv2.threshold(gray_image,thresh,255, cv2.THRESH_BINARY)
    cv2.imshow('thresh_egg',detected_thresh)
